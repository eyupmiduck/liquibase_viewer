...
test('builds a default query with no filters', () => {
  const query = buildChangelogQuery(DEFAULT_CONFIG, DEFAULT_CONFIG.changelog);

  assert.match(query.rowsSql, /FROM "liquibase"\."ddl_utils_databasechangelog"/);
